...
class Font implements Serializable {
	public const VALID_UNDERLINE = ['single', 'double', 'singleAccounting', 'doubleAccounting'];
	public const VALID_VERTICAL_ALIGN = ['superscript', 'subscript'];
...
//	private $family;
	 ...
	 * @return Font - $this
	 */
	public function setUnderline(?string $underline = null): self {
	 ...
	 * @return Font - $this
	 */
	public function setVerticalAlign(?string $vertAlign = null): self {
