...
class Alignment implements Serializable {
	public const VALID_HORIZONTAL = ['left', 'center', 'right', 'fill', 'centerContinuous', 'distributed', 'justify'];
	public const VALID_VERTICAL = ['top', 'center', 'bottom', 'distributed', 'justify'];
	public const VALID_READING_ORDER = ['leftToRight', 'rightToLeft'];
	 ...
	 */
	public function setHorizontal(?string $horizontal = null): self {
	 ...
	 * @return Alignment - $this
	 */
	public function setVertical(?string $vertical = null): self {
	 ...
	 * @return Alignment - $this
	 */
	public function setIndent(?int $indent = null): self {
		if (!is_null($indent)) {
	 ...
	 * @return Alignment - $this
	 */
	public function setReadingOrder(?string $readingOrder = null): self {
	 ...
	 * @return Alignment - $this
	 */
	public function setTextRotation(?TextRotation $textRotation = null): self {
