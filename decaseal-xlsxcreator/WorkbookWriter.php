...
class WorkbookWriter{
	...
	function __construct(DateTime $created = null, DateTime $modified = null, string $creator = null, string $lastModifiedBy = null, DateTime $lastPrinted = null){
	...
	function setCreated(DateTime $created){
		if($this->is_commited) throw new ElementCommittedException('Workbook is committed');
